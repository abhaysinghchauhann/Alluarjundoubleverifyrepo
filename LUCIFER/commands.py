...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/AAPRODUCTIONUPDATE'),
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='https://t.me/AAPRODUCTIONUPDATE')
                  ]]
        ...
        try:
            if IS_VERIFY and not await check_verification(client, message.from_user.id):
                btn = [[
                    ...
                    InlineKeyboardButton("❗Hᴏᴡ Tᴏ Vᴇʀɪғʏ❗", url="https://t.me/AAPRODUCTIONUPDATE/32")
                ]]
                return await message.reply_text(
